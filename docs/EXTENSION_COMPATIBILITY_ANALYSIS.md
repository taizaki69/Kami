...
| DEX execution | **Partial M1/M2 slice works**: exact prototype dispatch, class initialization, pinned constructors/getters, and BatCave's popular path execute through pure request construction to `awaitSuccess`; no end-to-end source yet |
