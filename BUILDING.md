...
|---|---|
| MihonCompatKit (parsers, VM, repo client, backup reader) | `swift test` on Windows/Swift 6.3.3 and GitHub's macOS runner — **63/63 tests pass**, including 8 real-APK execution/frontier assertions and 2 bounded request-model tests; release `compat-audit` builds |
