...
struct DexTypeHierarchy {
    ...
    private static let hostTypes: [String: TypeInfo] = {
        ...
        interfaceType("Ljava/lang/AutoCloseable;")
        interfaceType("Ljava/lang/Readable;")
        interfaceType("Ljava/io/Closeable;", extends: ["Ljava/lang/AutoCloseable;"])
        ...
        interfaceType("Ljava/util/Comparator;")
        ...
        classType("Ljava/util/MissingResourceException;", superclass: "Ljava/lang/RuntimeException;")
        ...
        classType("Ljava/lang/ClassLoader;")
        classType("Ljava/io/InputStream;", interfaces: ["Ljava/io/Closeable;"])
        classType("Ljava/io/Reader;", interfaces: ["Ljava/lang/Readable;", "Ljava/io/Closeable;"])
        classType("Ljava/io/InputStreamReader;", superclass: "Ljava/io/Reader;")
        classType("Ljava/util/ResourceBundle;")
        classType("Ljava/util/PropertyResourceBundle;", superclass: "Ljava/util/ResourceBundle;")
